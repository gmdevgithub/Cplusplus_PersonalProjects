...
//int main()
//{
//	//Created two arrays A & B each seeded 
//	std::vector < int > A(ARR_SIZE), B(TEST_ARR_SIZE);
//	Vectors(A, B, SEED1, SEED2);
//
//	// Print test (1st) vector before sorting its elements.
//	std::cout << "Random Numbers Before Sorting:\n\n";
//	printVector(A);
//	std::cout << std::endl;
//
...
//
//	std::cout << "\nLinear Search:\n";
//	//Use generic search function to handle a specific search
//	int counter1 = search(A, B, linearSearch);
//	//Counter is total matches, which we then pass to printstat, along with the size of our 2nd array.
...
//
//	std::cout << "\nBinary Search:\n";
//	//Uses same generic search function to handle a specific search
//	int counter2 = search(A, B, binarySearch);
//	//Same generic function with 2nd counter
